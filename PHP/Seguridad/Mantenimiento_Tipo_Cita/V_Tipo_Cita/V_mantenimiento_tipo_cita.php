...
$id_objeto = Obtener_Id_Objeto('V_modal_tipo_cita');
...
<div class="row">
    <div class="col-sm-12">
        ...
        <table id="tablaTipoCitaLoad" class="table">
            ...
            <button style="width: 20%;" class="btn btn-primary btn-agregar" data-toggle="modal" data-target="#modalNuevoEstadoCita">
                <i class="fa-solid fa-plus"></i> Agregar Tipo Cita</button>
                <?php endif; ?>
                ...
                $sql = "SELECT
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <button class="btn btn-warning" data-toggle="modal" data-target="#modalEditarTipoCita" onclick="cargarDatos('<?php echo $datos; ?>')">
