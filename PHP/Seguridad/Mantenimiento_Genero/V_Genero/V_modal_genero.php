...
<head>
    ...
    <script src="../C_Genero/C_funciones_genero.js"></script> <!-- Funciones para el CRUD -->
...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="modal fade" id="modalNuevoGenero" tabindex="-1" aria-labelledby="modalNuevoEsadoCitaLabel"
            aria-hidden="true">
            <div class="modal-dialog ">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modalNuevoEsadoCitaLabel">Nuevo Género</h1>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">                    

                        <label for="Genero">Escriba el género:</label>
                        <input type="text" name="Genero" id="Genero" placeholder="Nuevo género"
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" id="guardarGenero" class="btn btn-primary btn-block">Guardar</button>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="modalVerGenero" tabindex="-1" aria-labelledby="modalVerGeneroLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modalVerGeneroLabel">Ver género</h1>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <input type="text" id="IdGenero_L" hidden readonly class="form-control input-sm">
                        <label>Género:</label>
                        <input type="text" id="Genero_L" readonly class="form-control input-sm">
                        <!-- <label>Valor:</label>
                        <input type="text" id="valorGenero_L" readonly class="form-control input-sm"> -->
        ...
        <div class="modal fade" id="modalEditarGenero" tabindex="-1" aria-labelledby="modalEditarGeneroLabel"
            aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        <h1 class="modal-title fs-5" id="modalEditarGeneroLabel">Editar Género</h1>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                    </div>
                    <div class="modal-body">
                        <label for="Genero_E">Género:</label>
                        <input type="text" name="Genero_E" id="Genero_E" placeholder="Nombre del género"
                            class="form-control input-sm mayuscula">
                        <label for="IdGenero" hidden readonly>Id Genero:</label>
                        <input type="hidden" readonly name="IdGenero" id="IdGenero" class="form-control input-sm">
                    </div>
                    <div class="modal-footer">
                        <!-- <button type="button" class="btn btn-danger" data-bs-dismiss="modal">Cancelar</button> -->
                        <button type="button" id="actualizarGenero"
...
<script>
    $(document).ready(function () {
        $('#tablaGenero').load('./V_mantenimiento_genero.php');
    });
</script>

<script>
    $(document).ready(function () {
        $('#guardarGenero').click(function () {
           //$('#tablaTipoGenero').load('./V_mantenimiento_Genero.php');
