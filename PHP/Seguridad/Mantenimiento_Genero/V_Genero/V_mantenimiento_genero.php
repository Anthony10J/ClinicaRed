...
<div class="row">
    <div class="col-sm-12">
        ...
        <table id="tablaGeneroLoad" class="table">
            <!-- <br><h2>Mantenimiento de Parámetros</h2> -->
            <?php if (!$ocultarInsercion): ?>
            <button style="width: 20%;" class="btn btn-primary btn-agregar" data-toggle="modal" data-target="#modalNuevoGenero">
                <i class="fa-solid fa-plus"></i> Agregar Género</button>
                <?php endif; ?>
                ...
                $sql = "SELECT
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <!-- <button class="btn btn-primary" data-toggle="modal" data-target="#modalVerGenero" onclick="cargarDatosLectura('<?php echo $datos; ?>')"> -->
                            <!-- <i class="fa-solid fa-eye"></i></button> -->
                                <?php if (!$ocultarActualizacion): ?>
                            <button class="btn btn-warning" data-toggle="modal" data-target="#modalEditarGenero" onclick="cargarDatos('<?php echo $datos; ?>')">
