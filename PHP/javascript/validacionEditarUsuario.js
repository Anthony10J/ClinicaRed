...
export const validarFechaNacimiento = () => {
  ...
  const formulario = document.getElementById('editFormUser'); 
...
////Validacion Género
  ...
  // Agregamos un listener al evento submit del formulario para que llame a la función de validación
  const formulario2 = document.getElementById('editFormUser'); 
...
////Validacion ROL
  ...
  // Agregamos un listener al evento submit del formulario para que llame a la función de validación
  const formulario2rol = document.getElementById('editFormUser'); 
...
////Validacion ESTADO USUARIO
  ...
  // Agregamos un listener al evento submit del formulario para que llame a la función de validación
  const formulario2estado = document.getElementById('editFormUser'); 
  ...
  // Agregamos un listener al evento submit del formulario para que llame a la función de validación
  const formularioC = document.getElementById('editFormUser'); 
